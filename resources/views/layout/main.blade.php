...
<body class="custom-cursor">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                                <div class="footer-widget__contact">
                                    ...
                                    <ul class="footer-widget__contact-list list-unstyled">
                                        <li>
                                            <p>Quartier Industriel, croisement des avenues Kato et Mayenge, réf Entre les taxis jaunes et le Take Away </p>
                                        </li>
                                        <li>
                                            <p><a href="tel:2195550114">(+243) 976 551 024</a></p>
                                        </li>
                                        <li>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="/" aria-label="logo image"><img src="assets/images/resources/logo-1.png" width="150"
                        alt="" /></a>
            </div>
            <!-- /.logo-box -->
            ...
            <ul class="mobile-nav__contact list-unstyled">
                <li>
                    ...
                    <a href="mailto:needhelp@packageName__.com">needhelp@healing.com</a>
                </li>
                <li>
                    <i class="fas fa-phone"></i>
                    <a href="tel:(+243) 976 551 024">(+243) 976 551 024</a>
                </li>
